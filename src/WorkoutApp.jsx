  ...
  },
  {
    ...
    exercises: [
      ...
      },
      {
        ...
        notes: "Ribs down",
        demo_link:
          "https://www.youtube.com/results?search_query=Dead+Bugs+proper+form",
      },
      {
        name: "Weighted Plank",
        sets: "3",
  ...
  },
  {
    ...
    exercises: [
      ...
      },
      {
        ...
        weight: "-",
        rest: "-",
        notes: "Do: Hip circles (10 each way), 90/90 hip stretch (60s each), Cat-cow (10 reps), Thoracic rotations (10 each), World's greatest stretch (5 each side)",
        demo_link:
  ...
  },
  {
    ...
    exercises: [
      ...
      },
      {
        ...
        notes: "Slow",
        demo_link:
          "https://www.youtube.com/results?search_query=Weighted+Dead+Bug+proper+form",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    exercises: [
      ...
      },
      {
        ...
        weight: "-",
        rest: "-",
        notes: "Do: Deep squat hold (60s), Hip 90/90 stretch (90s each), Arm circles (20 each), Shoulder dislocations with band (10), Thread the needle (60s each), Child's pose (60s)",
        demo_link:
